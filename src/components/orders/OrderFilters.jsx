...
export default function OrderFilters({ filters, setFilters, agents }) {
  const hasFilters = filters.status || filters.source || filters.agent || filters.department || filters.search;
